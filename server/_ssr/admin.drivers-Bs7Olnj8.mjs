...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.drivers-Bs7Olnj8.js
...
function AdminDrivers() {
	...
	const save = async (e) => {
		...
		const { error } = await (editing ? supabase.from("drivers").update(payload).eq("id", editing.id) : supabase.from("drivers").insert(payload));
		if (error) {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-4 w-4 mr-2" }), "New driver"]
					})
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "max-w-lg",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, { children: [editing ? "Edit" : "New", " driver"] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						onSubmit: save,
						className: "space-y-3",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "License number" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
									name: "license_number",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "px-6 py-3",
							children: d.photo_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: d.photo_url,
								alt: d.name,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: d.license_number || "—"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "px-6 py-3 text-muted-foreground",
							children: d.phone || d.email || "—"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "px-6 py-3",
...
//#endregion
export { AdminDrivers as component };
